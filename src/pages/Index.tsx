...
import { Play, BookOpen, Info, Share2, Menu, Heart, History } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              variant="outline"
              className="w-full text-lg h-14 animate-fade-in stagger-6 opacity-0 fill-mode-forwards hover-scale"
              size="lg"
            >
